...
```{r, echo=FALSE}
library(gridExtra)
p1 <- ggplot(data = EmployeesTotalPrivate, aes(x = Label, y = Value,)) + 
  geom_line() + 
  theme(axis.text.x=element_text(angle = 45)) +
  ggtitle("Employment from 2011 to 2021") +
  xlab("Time") + ylab("Employees (in thousands)")

p2 <- ggplot(data = employees_total, aes(x = Label, y = Value,
...
p3 <- ggplot(data = employees_gp, aes(x = Label, y = Value,
       group = as.factor(Industry), color = Industry)) + 
  geom_line() + 
  theme(axis.text.x=element_text(angle = 45)) +
  ggtitle("Employment from 2011 to 2021 in Goods-producing sector") +
  xlab("Time") + ylab("Employees (in thousands)")
p4 <- ggplot(data = employees_sp, aes(x = Label, y = Value,
       group = as.factor(Industry), color = Industry)) + 
  geom_line() + 
  theme(axis.text.x=element_text(angle = 45)) +
...
p5 <- ggplot(data = employees_gp_manu, aes(x = Label, y = Value,
       group = as.factor(Industry), color = Industry)) + 
  geom_line() + 
  theme(axis.text.x=element_text(angle = 45)) +
  ggtitle("Employment from 2011 to 2021 in Manufacturing industry") +
  xlab("Time") + ylab("Employees (in thousands)")
p6 <- ggplot(data = employees_sp_ttu, aes(x = Label, y = Value,
       group = as.factor(Industry), color = Industry)) + 
  geom_line() + 
  theme(axis.text.x=element_text(angle = 45)) +
